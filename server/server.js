...
io.on('connection', function (socket) { //2
  ...
  socket.on('newItem', function (data) { //7
    ...
    console.log(data.msg); //8 (note: this log will be on your server's terminal)
    axios.post('http://5cadffe4845049001423c1f1.mockapi.io/authors', data.msg)
      .then((res) => {
  ...
  socket.on('deleteItem', function (data) {
    ...
    //axios delete call
    axios.delete(`http://5cadffe4845049001423c1f1.mockapi.io/authors/${data.msg}`)
      .then((res) => {
  ...
  socket.on('updateItem', function (data) {
    ...
    //axios update call
    axios.put(`http://5cadffe4845049001423c1f1.mockapi.io/authors/${data.msg.id}`, data.msg)
      .then((res) => {
        socket.emit('success', { msg: { status: 'success', action: 'updated' } })
        returnAll();
      })
      .catch((err) => {
        console.log(err);
  ...
  function returnAll() {
    axios.get('http://5cadffe4845049001423c1f1.mockapi.io/authors')
      .then((res) => {
